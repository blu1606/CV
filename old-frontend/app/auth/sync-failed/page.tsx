          ...
          <div className="container mx-auto px-4 py-24 md:py-40">
            <div className="max-w-2xl mx-auto text-center space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-1 bg-orange-accent text-background text-xs font-mono">
                <TriangleAlert className="w-4 h-4" /> SYNC FAILED
              </div>
              <h1 className="font-serif text-4xl md:text-6xl leading-[1.1] text-black text-balance">Sync Failed</h1>
              <p className="text-lg text-black/80 leading-relaxed">
                We couldn’t complete the initial data sync. Please try again, or you can proceed and re-sync later.
              </p>

              <div className="flex items-center justify-center gap-3">
                <Button
                  size="lg"
                  className="font-mono text-sm border-2 border-foreground/40 bg-transparent text-black hover:bg-foreground/10 h-12 px-6 gap-2"
                  variant="outline"
                  asChild
                >
